This step-by-step guide provides the context to run the [`Snakemake` workflows](Snakepit) and seamlessly implement them to your pedigreed variants to identify crossover and non-crossover events.
